...
const Currently = ({All , Update}) => {
    ...
    /* 
      ...
      - here we do not need all shelves we just need one shelf named = "currentlyReading"
      - so we will loop on all array's items and retun only named = "currentlyReading" if else, skip
      - so now shelfCase = the shelf named = "currentlyReading" which have 2 books
    */
